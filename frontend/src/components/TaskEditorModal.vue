      ...
      <div class="w-full max-w-2xl border border-fg2/20 bg-bg1 p-6 shadow-panel">
        ...
        <label class="mt-6 block text-[11px] font-semibold uppercase tracking-[0.28em] text-fg3">
          ...
          <textarea
            v-model="description"
            rows="6"
            class="mt-2 w-full border border-fg2/20 bg-bg0 px-4 py-3 text-sm leading-6 text-fg1 outline-none transition hover:border-fg2/40 focus:border-aqua/50 focus:ring-1 focus:ring-aqua/50"
        ...
        <label class="mt-5 block text-[11px] font-semibold uppercase tracking-[0.28em] text-fg3">
          ...
          <select
            v-model="priority"
            class="mt-2 w-full border border-fg2/20 bg-bg0 px-4 py-3 text-sm text-fg1 outline-none transition hover:border-fg2/40 focus:border-aqua/50 focus:ring-1 focus:ring-aqua/50"
          >
            <option value="high">
              High
            </option>
