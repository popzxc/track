...
From any directory, put the project name or alias near the start of the note for the most reliable first-run capture:
...
- the shell prelude was never saved in the WebUI, in which case `track` sends you to **Settings** to finish runner setup
